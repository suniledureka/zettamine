...
export const Login = () => {
  ...
  async function handleLoginGuest(){
    //email.current.value = process.env.REACT_APP_GUEST_LOGIN;
	  email.current.value = 'sunil@example.com';
